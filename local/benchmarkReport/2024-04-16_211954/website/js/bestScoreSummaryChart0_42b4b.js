...
var chart_bestScoreSummaryChart0_42b4b = new Chart(document.getElementById('chart_bestScoreSummaryChart0_42b4b'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_42b4b.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_42b4b.resize();
});