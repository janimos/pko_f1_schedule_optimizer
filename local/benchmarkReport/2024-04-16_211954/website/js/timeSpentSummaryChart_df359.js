...
var chart_timeSpentSummaryChart_df359 = new Chart(document.getElementById('chart_timeSpentSummaryChart_df359'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_df359.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_df359.resize();
});