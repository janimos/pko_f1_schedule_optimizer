...
var chart_winningScoreDifferenceSummaryChart0_187ac = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_187ac'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_187ac.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_187ac.resize();
});