...
var chart_worstScoreDifferencePercentageSummaryChart0_1c7e3 = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_1c7e3'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_1c7e3.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_1c7e3.resize();
});