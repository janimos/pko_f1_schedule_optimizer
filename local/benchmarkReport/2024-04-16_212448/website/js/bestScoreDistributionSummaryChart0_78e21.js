...
var chart_bestScoreDistributionSummaryChart0_78e21 = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_78e21'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_78e21.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_78e21.resize();
});