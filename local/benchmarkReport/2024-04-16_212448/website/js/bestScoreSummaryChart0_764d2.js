...
var chart_bestScoreSummaryChart0_764d2 = new Chart(document.getElementById('chart_bestScoreSummaryChart0_764d2'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_764d2.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_764d2.resize();
});