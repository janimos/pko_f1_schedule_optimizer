...
var chart_winningScoreDifferenceSummaryChart0_d2984 = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_d2984'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_d2984.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_d2984.resize();
});