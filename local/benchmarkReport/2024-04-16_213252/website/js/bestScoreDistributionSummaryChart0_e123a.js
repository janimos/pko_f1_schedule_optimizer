...
var chart_bestScoreDistributionSummaryChart0_e123a = new Chart(document.getElementById('chart_bestScoreDistributionSummaryChart0_e123a'), {
    type: 'boxplot',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreDistributionSummaryChart0_e123a.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreDistributionSummaryChart0_e123a.resize();
});