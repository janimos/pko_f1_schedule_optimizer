...
var chart_bestScoreSummaryChart0_eba21 = new Chart(document.getElementById('chart_bestScoreSummaryChart0_eba21'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_eba21.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_eba21.resize();
});