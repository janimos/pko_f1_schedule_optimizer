...
var chart_timeSpentSummaryChart_323e2 = new Chart(document.getElementById('chart_timeSpentSummaryChart_323e2'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_323e2.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_323e2.resize();
});