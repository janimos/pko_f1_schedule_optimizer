...
var chart_worstScoreDifferencePercentageSummaryChart0_ce323 = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_ce323'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_ce323.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_ce323.resize();
});