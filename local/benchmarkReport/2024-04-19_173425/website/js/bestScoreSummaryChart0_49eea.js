...
var chart_bestScoreSummaryChart0_49eea = new Chart(document.getElementById('chart_bestScoreSummaryChart0_49eea'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_bestScoreSummaryChart0_49eea.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_bestScoreSummaryChart0_49eea.resize();
});