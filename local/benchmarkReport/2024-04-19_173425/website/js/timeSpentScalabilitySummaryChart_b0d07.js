...
var chart_timeSpentScalabilitySummaryChart_b0d07 = new Chart(document.getElementById('chart_timeSpentScalabilitySummaryChart_b0d07'), {
    type: 'line',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentScalabilitySummaryChart_b0d07.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentScalabilitySummaryChart_b0d07.resize();
});
