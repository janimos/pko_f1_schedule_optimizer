...
var chart_timeSpentSummaryChart_88d43 = new Chart(document.getElementById('chart_timeSpentSummaryChart_88d43'), {
    type: 'bar',
    data: {
        labels: [
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    30000, 30000, 30000, 30001, 30000, 30000, 30000
                  ]
                }, 
{
                ...
                }, 
{
                  ...
                  ,
                  data: [
                    30000, 30001, 30000, 30000, 30000, 30000, 30000
                  ]
                }, 
{
...
window.addEventListener('beforeprint', () => {
  chart_timeSpentSummaryChart_88d43.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_timeSpentSummaryChart_88d43.resize();
});