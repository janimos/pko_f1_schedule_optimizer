...
var chart_winningScoreDifferenceSummaryChart0_2710e = new Chart(document.getElementById('chart_winningScoreDifferenceSummaryChart0_2710e'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_winningScoreDifferenceSummaryChart0_2710e.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_winningScoreDifferenceSummaryChart0_2710e.resize();
});