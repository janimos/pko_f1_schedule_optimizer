...
var chart_worstScoreDifferencePercentageSummaryChart0_e79b6 = new Chart(document.getElementById('chart_worstScoreDifferencePercentageSummaryChart0_e79b6'), {
    type: 'bar',
    data: {
        labels: [
...
window.addEventListener('beforeprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_e79b6.resize(1280, 720);
});
window.addEventListener('afterprint', () => {
  chart_worstScoreDifferencePercentageSummaryChart0_e79b6.resize();
});